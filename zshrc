...
for MACHINE in andre burberry ford mcqueen westwood sander conran hackett prada everest beckham
do
...
work() {
	...
	for HOSTNAME in reddit.com news.ycombinator.com facebook.com news.bbc.co.uk twitter.com football365.com
	do
